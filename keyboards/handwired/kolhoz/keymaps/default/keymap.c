...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LDEF] = LAYOUT_split_2_3x5_4_3(
        ...
        KC_1,              KC_Z,            KC_X,            KC_C,            KC_V,        KC_B,                                                                                   KC_N,            KC_M,       KC_COMMA,          KC_DOT,        KC_QUOTE,
        KC_0,     OSM(MOD_LSFT),   OSM(MOD_LCTL),   OSM(MOD_LGUI),   OSM(MOD_LALT),   OSL(LNUM),   LT(LNAV,KC_SPC),   OSL(LSYM),            OSL(LSYM),   LT(LNAV,KC_SPC),         KC_NO,   OSM(MOD_RALT),  OSM(MOD_RGUI),   OSM(MOD_RCTL),   OSM(MOD_RSFT)
    ),
    [LSYM] = LAYOUT_split_2_3x5_4_3(
        ...
        KC_NO,     KC_EXCLAIM, KC_UNDERSCORE,      KC_MINUS,        KC_PLUS,     KC_PIPE,                                            KC_LCBR,      KC_RCBR,         KC_LT,         KC_GT,       KC_DQUO,
        KC_NO,        KC_TRNS,       KC_TRNS,       KC_TRNS,        KC_TRNS,       KC_NO,     KC_NO,    KC_NO,       KC_NO,   KC_NO,   KC_NO,      KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS
    ),
    [LNUM] = LAYOUT_split_2_3x5_4_3(
        ...
        KC_NO,          KC_F9,        KC_F10,        KC_F11,         KC_F12,       KC_NO,                                              KC_NO,         KC_7,          KC_8,          KC_9,         KC_NO,
        KC_NO,        KC_TRNS,       KC_TRNS,       KC_TRNS,        KC_TRNS,       KC_NO,     KC_NO,    KC_NO,       KC_NO,   KC_NO,   KC_NO,      KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS
    ),
    [LNAV] = LAYOUT_split_2_3x5_4_3(
        ...
        KC_NO,          KC_NO,         KC_NO,         KC_NO,         KC_NO,        KC_NO,                                      RCTL(KC_LEFT),        KC_NO,         KC_NO, RCTL(KC_RIGHT),        KC_NO,
        KC_NO,          KC_NO,         KC_NO,         KC_NO,         KC_NO,     TO(LDEF),  TO(LDEF), TO(LDEF),       KC_NO,   KC_NO,   KC_NO,      KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS
    )
};
