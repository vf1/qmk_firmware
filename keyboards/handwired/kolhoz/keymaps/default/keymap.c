...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LDEF] = LAYOUT_split_2_3x5_4_3(
        ...
        KC_1,              KC_Z,            KC_X,            KC_C,            KC_V,        KC_B,                                                                                   KC_N,            KC_M,       KC_COMMA,          KC_DOT,        KC_QUOTE,       KC_2,
    ...
    [LNAV] = LAYOUT_split_2_3x5_4_3(
        ...
        KC_NO,          KC_NO,         KC_NO,         KC_NO,         KC_NO,     TO(LDEF),  TO(LDEF), TO(LDEF),       KC_NO,   KC_NO,   KC_NO,      KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_NO
    )
};
